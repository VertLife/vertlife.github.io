...
- **FOR DISPLAY ONLY**: MCC consensus trees of the **completed** trees.  Note that consensus trees are inappropriate for consensus since they contain taxonomically imputed species that vary in topological position within constraints (genus or family) across the credible set of trees.  See the ["Recommended uses"](https://journals.plos.org/plosbiology/article?id=10.1371/journal.pbio.3000494#sec018) section of our PLOS Biology article for more discussion of this topic.
