...
TableQueryWrapper.prototype.drawToTable = function () {
    var i;
    this.toDataTable = new google.visualization.DataTable();
    for(i=0;i<this.currentDataTable.getNumberOfColumns();i++) {
        this.toDataTable.addColumn(
            this.currentDataTable.getColumnType(i),
            this.currentDataTable.getColumnLabel(i)
        )
    }
    this.totable.draw(this.toDataTable,this.tableOptions);
